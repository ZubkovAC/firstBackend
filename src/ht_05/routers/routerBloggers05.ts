...
export const RouterBloggers05 =  Router({})
...
RouterBloggers05.get('/:id',async (req: Request, res: Response) => {
...
RouterBloggers05.get('/:idBloggers/posts',async (req: Request, res: Response) => {
    const pageN = pageNumber(req.query.PageNumber as string)
    const pageS = pageSize(req.query.PageSize as string)
...
RouterBloggers05.post('/:idBlogger/posts',
